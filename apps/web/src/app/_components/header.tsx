...
import { DropdownMenu, DropdownMenuContent, DropdownMenuItem, DropdownMenuTrigger } from "@atena/ui/dropdown-menu";
        ...
        <div className="w-full flex justify-end gap-4">
          ...
          <DropdownMenu>
            <DropdownMenuTrigger className="flex items-center gap-2">              
              <Avatar className="w-8 h-8 outline outline-2 outline-primary select-none">
